...
Users with access to paid resources have some extra flags and a tool for monitoring their nodes.
...
We have a <code>whatsonmynode</code> script that does a <code>qhost -j</code> on each of the nodes belonging to your project, so you can see which nodes you have, what is running on them and from which user.
