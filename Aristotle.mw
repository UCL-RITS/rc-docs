...
<code>aristotle.rc.ucl.ac.uk</code>

This is a DNS round-robin pointing to two identical machines, <code>aristotle01</code> and <code>aristotle02</code>.

The userid and password you need to connect with are those provided to you by [http://ucl.ac.uk/isd Information Services Division].

If you experience difficulties with your login, please make sure that you are typing your UCL user ID and your password correctly. If you still cannot get access, please contact us on [mailto:rc-support@ucl.ac.uk rc-support@ucl.ac.uk].

If you are outside the UCL firewall, you will need to connect to Socrates first, as with [[Accessing Legion|Legion]]

= User Environment =

Aristotle runs Red Hat Enterprise Linux 6.5 and NFS mounts the [[Legion Software|Legion software stack]].  This means a large number of packages are theoretically available although many of them may not work as they were build for Legion's Scientific Linux 5.x operating system.  As this machine is intended for teaching, work has focused on getting specific applications required for specific courses to work and these are:
...
Packages are available through modules and users should consult the relevant [[Legion user environment|Legion modules documentation]].
...
* NONMEM (atlas/3.8.3/gnu.4.6.3 nonmem/7.3.0/gfortran_rh6.5)
